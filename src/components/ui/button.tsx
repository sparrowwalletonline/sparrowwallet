...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 opacity-100 visible z-10",
  {
    variants: {
      variant: {
  ...
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        ref={ref}
        {...props}
        style={{ opacity: 1, visibility: 'visible', ...props.style }}
      />
    )
  }
)
