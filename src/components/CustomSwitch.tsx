  ...
  ({ checked, onCheckedChange, disabled = false, className, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          "relative inline-flex h-[18px] w-[36px] shrink-0 cursor-pointer rounded-full transition-colors duration-200",
      ...
      >
        <span
          className={cn(
            ...
            "h-[17px] w-[17px] transform transition-transform duration-200",
